...
class FeedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //скрываем кнопку показать новые посты
        ...
        viewModel.newerCount.observe(viewLifecycleOwner) {
            //если список новых постов отличается от 0, показываем кнопку показать новые посты
        ...
        //нажание на кнопку новые записи(new posts)
